   ...
   function search() {
    ...
    $.ajax({
        ...
        success: function(response) {
            // Handle success responses here, errors will be handled by global handler
        ...
        // Removed error handler - let global handler take care of it
    });
}
    ...
    $(document).on('click', '#delete_customer', function(event) {
        ...
        if (confirm('Sure you want to delete the customer?')) {
            ...
            $.ajax({
                ...
                // Error handling by global handler
            });
        }
    });
