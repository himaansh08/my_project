...
<script>
    function search() {
    var searchbartxt = $('#search-bar').val().trim();
    ...
    $('#search-results').html('<div class="text-center"><i class="fa fa-spinner fa-spin"></i> Searching...</div>');
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            if (response.includes('No results found')) {
                $('#responseMessage').html('<div class="alert alert-warning">No matching users found.</div>');
            } else if (response.includes('Please enter a search term')) {
                $('#responseMessage').html('<div class="alert alert-info">Please enter a search term.</div>');
            } else if (response.includes('Error executing search query')) {
                $('#responseMessage').html('<div class="alert alert-danger">Error executing search. Please try again.</div>');
            } else {
                $('#responseMessage').html('<div class="alert alert-success">Search completed successfully.</div>');
            }
        },
        error: function(xhr, status, error) {
            ...
            $('#search-results').html('');
            $('#responseMessage').html('<div class="alert alert-danger">There was an error processing your search. Please try again.</div>');
        }
    });
}
